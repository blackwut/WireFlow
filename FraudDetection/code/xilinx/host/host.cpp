...
int main(int argc, char** argv) {
    ...
    std::string bitstream  = "./kernels/fdtc111/hw/build/fdtc.xclbin";
    ...
    std::string dataset_filepath = "../../Datasets/FD/dataset.dat";
    ...
    dump_benchmark(
        ...
        "FraudDetection",
        bitstream,
        {"MemoryReader", "Predictor", "MemoryWriter"},
        {generator_num_threads, generator_num_threads, drainer_num_threads},
        generator_num_buffers,
        generator_batch_size,
        drainer_num_buffers,
        drainer_batch_size,
