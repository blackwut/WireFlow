...
int main(int argc, char** argv) {
    ...
    std::string bitstreamFilename  = "./kernels/sds" + std::to_string(par) + std::to_string(par) + std::to_string(par) + std::to_string(par) + "/hw/build/sds.xclbin";
